/*
    Procedimiento que retorna los tipos de uso de una propiedad
*/
...
ALTER PROCEDURE [dbo].[ObtenerUsos]
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT TUP.[nombre] AS 'Nombre'
        FROM [dbo].[TipoUsoPropiedad] TUP
        ORDER BY TUP.[nombre] ASC;
        SELECT @outResultCode AS 'resultCode';
