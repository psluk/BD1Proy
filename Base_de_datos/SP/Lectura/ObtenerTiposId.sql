/*
    Procedimiento que retorna los tipos de documento de identidad
*/
...
ALTER PROCEDURE [dbo].[ObtenerTiposId]
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT TDI.[nombre] AS 'Nombre'
        FROM [dbo].[TipoDocumentoId] TDI
        ORDER BY TDI.[nombre] ASC;
        SELECT @outResultCode AS 'resultCode';
